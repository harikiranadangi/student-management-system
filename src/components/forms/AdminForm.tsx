...
const AdminForm = ({
    ...
    const [img, setImg] = useState<any>(null); // ✅ Define setImg before using it
    ...
    const onSubmit = handleSubmit((f) => {
        ...
        // createAdmin(data); // ✅ Pass both arguments
    });
    ...
    return (
        <form className="flex flex-col gap-8" onSubmit={onSubmit}>
            ...
            <div className="flex flex-wrap justify-between gap-4">
                <InputField label="Name" name="full_name" defaultValue={data?.full_name} register={register} error={errors?.full_name} />
