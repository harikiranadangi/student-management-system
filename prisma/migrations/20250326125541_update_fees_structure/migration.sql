/*
  ...
  - The required column `id` was added to the `FeesStructure` table with a prisma-level default value. This is not possible if the table is not empty. Please add this column as optional, then populate it before making it required.

*/
-- AlterTable
ALTER TABLE "FeesCollection" ADD COLUMN     "feesStructureId" TEXT;
